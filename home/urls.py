...
urlpatterns = [
    ...
    path('post/detail/<post_id>/<post_slug>/', views.PostDetailView.as_view(), name='post_detail' ),
    ...
    path('post/create/<int:user_id>/', views.PostCreateView.as_view(), name='post_create' ),
